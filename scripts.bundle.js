...
var spritesheetPromise = fetch("assets/images/spritesheet.svg")
    .then(function (r) { return r.text(); })
    .then(function (txt) { return new DOMParser().parseFromString(txt, "image/svg+xml"); });
var SPRITE_ATTR = "data-inline-sprite";
function insertIconFragment(spriteId, insertPoint) {
    return spritesheetPromise.then(function (fragment) {
        var defs = fragment.querySelector("svg > defs");
        var icon = fragment.getElementById(spriteId).cloneNode(true);
...
function displaySvgs() {
    [].forEach.call(document.querySelectorAll("[" + SPRITE_ATTR + "]"), function (insertPoint) {
        var spriteId = insertPoint.getAttribute(SPRITE_ATTR);
...
var ctx            = __webpack_require__(23)
  ...
  , aFunction      = __webpack_require__(12)
  , forOf          = __webpack_require__(35)
  , isIterable     = __webpack_require__(114)
  , $iterCreate    = __webpack_require__(55)
  , step           = __webpack_require__(71)
  , isObject       = __webpack_require__(4)
  , toIObject      = __webpack_require__(11)
...
var $export = __webpack_require__(0)
  , define  = __webpack_require__(103);
...
if(!(TO_PRIMITIVE in proto))__webpack_require__(14)(proto, TO_PRIMITIVE, __webpack_require__(125));
